...
This repository contains some data and code that will be used as an example for the Code Horizons course on Using GitHub for Data Analysis. A copy ("fork") of this repository will be provided for you in the GitHub Classroom for the course. I will use it for demonstration purposes in the class, and you can feel free to play around with it to test things out.
